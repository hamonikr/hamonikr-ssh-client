...
sub _getDefaultConfig {
    ...
    $$cfg{'treeFavourites'}{''}             = ['Favourites Tree',  'edit_node',            'Edit selected node'];
    $$cfg{'treeFavourites'}{''}             = ['Favourites Tree',  'del_favourite',        'Remove connection from favourites'];
    $$cfg{'treeHistory'}{''}                = ['History Tree',     'edit_node',            'Edit selected node'];
    $$cfg{'treeClusters'}{''}               = ['Clusters Tree',    'edit_node',            'Edit selected node'];
    $$cfg{'treeConnections'}{''}            = ['Connections Tree', 'edit_node',            'Edit selected node'];
    $$cfg{'treeConnections'}{''}            = ['Connections Tree', 'add_favourite',        'Add connection to favourites'];
    $$cfg{'treeConnections'}{''}            = ['Connections Tree', 'del_favourite',        'Remove connection from favourites'];
    $$cfg{'treeConnections'}{''}            = ['Connections Tree', 'find',                 'Find in connection tree'];
    $$cfg{'treeConnections'}{''}            = ['Connections Tree', 'expand_all',           'Expand tree completly'];
    $$cfg{'treeConnections'}{''}            = ['Connections Tree', 'collaps_all',          'Collaps tree completly'];
    $$cfg{'treeConnections'}{'Ctrl+d'}      = ['Connections Tree', 'clone',                'Clone connection'];
    $$cfg{'treeConnections'}{''}            = ['Connections Tree', 'copy',                 'Copy node'];
    $$cfg{'treeConnections'}{''}            = ['Connections Tree', 'cut',                  'Cut node'];
    $$cfg{'treeConnections'}{''}            = ['Connections Tree', 'paste',                'Paste node'];
    $$cfg{'treeConnections'}{''}            = ['Connections Tree', 'protection',           'Toggle protection'];
    $$cfg{'treeConnections'}{'F2'}          = ['Connections Tree', 'rename',               'Rename node'];
    $$cfg{'treeConnections'}{''}            = ['Connections Tree', 'connect_node',         'Connect selected node'];
    ...
    $$cfg{'pacmain'}{''}                    = ['Main Window',       'find',                'Find in connection tree'];
    $$cfg{'pacmain'}{'Ctrl+q'}              = ['Main Window',       'quit',                'Exit Ásbrú'];
    $$cfg{'pacmain'}{'Ctrl+T'}              = ['Main Window',       'localshell',          'Open a local shell'];
    $$cfg{'pacmain'}{''}                    = ['Main Window',       'showconnections',     'Show/Hide connections list'];
    ...
    $$cfg{'terminal'}{''}                   = ['Terminal',          'remove_from_cluster', 'Remove terminal from cluster'];
    ...
    $$cfg{'terminal'}{''}                   = ['Terminal',          'paste-passwd',        'Paste terminal password'];
    $$cfg{'terminal'}{''}                   = ['Terminal',          'paste-delete',        'Paste and regex delete'];
    $$cfg{'terminal'}{''}                   = ['Terminal',          'hostname',            'Guess hostname'];
    ...
    $$cfg{'terminal'}{''}                   = ['Terminal',          'find',                'Find in connection tree'];
    $$cfg{'terminal'}{'CtrlShift+F4'}       = ['Terminal',          'closealltabs',        'Close all tabs'];
    $$cfg{'terminal'}{''}                   = ['Terminal',          'close-disconected',   'Close disconnected sessions'];
    $$cfg{'terminal'}{''}                   = ['Terminal',          'duplicate',           'Duplicate connection'];
    $$cfg{'terminal'}{'Ctrl+R'}             = ['Terminal',          'restart',             'Restart connection (close and start)'];
    $$cfg{'terminal'}{''}                   = ['Terminal',          'infotab',             'Show the Info tab'];
    $$cfg{'terminal'}{'Ctrl+F3'}            = ['Terminal',          'find-terminal',       'Find Terminal'];
    $$cfg{'terminal'}{''}                   = ['Terminal',          'showconnections',     'Show/Hide connections list'];
    $$cfg{'terminal'}{''}                   = ['Terminal',          'edit_node',           'Edit Connection'];
